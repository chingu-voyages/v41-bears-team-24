      ...
      <div className='mt-6 w-full'>
        <div className='flex justify-center'>
          ...
          <input type="text" placeholder="Search..." value={searchQuery} onChange={(e) => setSearchQuery((e.target as HTMLInputElement).value)}
                className="m-2 w-96 px-2 py-3 text-black placeholder-black bg-slate-50 rounded-full shadow-lg shadow-gray-400 border-transparent focus:border-transparent focus:ring-0"/>
        </div>
          {/* menu categories */}
